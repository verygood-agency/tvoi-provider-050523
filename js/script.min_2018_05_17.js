...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(document.getElementById('demo-nouislider')) {
        ...
        noUiSlider.create(demoNoUiSlider, {
          start: [demoNoUiSliderStartInput.value.replace('от '), demoNoUiSliderEndInput.value.replace('до ')],
          connect: true,
          step: 1,
          range: {
            'min': 0,
        ...
        demoNoUiSlider.noUiSlider.on('update', function( values, handle ) {
          ...
          if ( handle ) {
            demoNoUiSliderEndInput.value = 'до '+Math.round(value);
          } else {
            demoNoUiSliderStartInput.value = 'от ' +Math.round(value);
          }
        });
        demoNoUiSliderEndInput.addEventListener('change', function(){
          demoNoUiSlider.noUiSlider.set([null, this.value.replace('до ')]);
        });
        demoNoUiSliderStartInput.addEventListener('change', function(){
          demoNoUiSlider.noUiSlider.set([this.value.replace('от '), null]);
        });
